        ...
        <div class="row">
          ...
          <div class="col-lg-6 d-flex align-items-center mb-5">
            <div class="rounded partner-card-first text-center text-lg-start">
              ...
              <p class="partner-card-desc mt-5 mb-5"><?php echo esc_html($description); ?></p>
            ...
            <div class="col-lg-4 align-items-center">
                ...
                if ( $left_query->have_posts() ) :
                    while ( $left_query->have_posts() ) : $left_query->the_post();
                        ...
                        <div class="shadow w-100 bg-upevent">
                            ...
                            <div class="mt-4 mb-4 eventcontent"><?php the_excerpt(); ?></div>
                        ...
                        while ( $right_query->have_posts() ) : $right_query->the_post();
                            ...
                            <div class="col-12">
                                <div class="d-flex pb-4 news-section">
                                    ...
                                    <?php if (has_post_thumbnail()): ?>
                                        <div class="me-5 event-img  flex-shrink-0" style="width: 148px; height: 136px;">
          ...
          while ($loop->have_posts()) : $loop->the_post();
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
              <div class="custom-card h-100 d-flex flex-column justify-content-between">
                <div>
                  <div class="icon-product mb-4">
                    <?php if (has_post_thumbnail()) : ?>
                      <?php the_post_thumbnail('woocommerce_thumbnail', ['class' => 'img-fluid']); ?>
                    <?php else : ?>
                      <img src="<?php echo wc_placeholder_img_src(); ?>" alt="Placeholder" class="img-fluid" />
                    <?php endif; ?>
                  </div>
                  <h5 class="fw-bold product-title"><?php the_title(); ?></h5>
                  <div class="product-desc">
                    <?php echo wp_trim_words(get_the_excerpt()); ?>
                  </div>
                </div>
                <a href="<?php the_permalink(); ?>" class="btn btn-primary ms-auto <?php echo ($post_index == 1) ? 'producteventbtn' : 'arrowbtn'; ?>">
                <?php echo ($post_index == 1) ? 'Explore' : ''; ?> <i class="icon icon-arrow-right"></i>
                </a>
              </div>
            </div>
          <?php endwhile;
...
add_shortcode('products_list', 'woo_products_list');
...
function custom_slider_shortcode() {
    ...
    <div class="container">
      <div class="row">
        <div class="custom-slider-container position-relative mb-3">
          <input type="range" class="form-range" min="1000" max="10000" step="100" value="0" id="myRange">
          <div id="tooltip" class="tooltip-custom">
            <span class="tiptitle">Your Current <br>Success Rate of <br>Equipment</span><br><strong>0%</strong>
          </div>
        </div>
        <div class="d-flex justify-content-between small text-muted text-range flex-wrap">
        <span>IN USD</span>
          <?php
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        function updateSlider() {
          ...
          const successRate = Math.round(percent);

          // Fill background
          slider.style.background = `linear-gradient(to right, #2787FB ${percent}%, #e0e0e0 ${percent}%)`;

          // Tooltip content
          tooltip.innerHTML = `<span class="tiptitle">Your Current <br>Success Rate of <br>Equipment</span><br><strong>${successRate}%</strong>`;

          // Tooltip position
          const sliderRect = slider.getBoundingClientRect();
          const thumbWidth = 24;
          const offset = (slider.offsetWidth - thumbWidth) * (percent / 100) + (thumbWidth / 2);
...
add_shortcode('range_filter', 'custom_slider_shortcode');
